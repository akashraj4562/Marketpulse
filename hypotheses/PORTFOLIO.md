...
| Metric | Count |
|---|---|
| **Active** (confidence ≥ 60%) | 0 |
| **Developing** (confidence < 60%) | 0 |
| **Predicted** (unvalidated, AI-generated) | 0 |
| **Retired** (disproven / expired) | 0 |
| **Total live** | 0 |
| **P1 hypotheses** (validate daily) | 0 |
| **P2 hypotheses** (validate every 48h) | 0 |
...
## Next hypothesis ID
**H-0001** ← Use this for the next new hypothesis, then increment.
